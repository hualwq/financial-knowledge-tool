  ...
  <div>
    ...
    <el-form :model="form" ref="formRef" label-width="120px">
      ...
      <el-form-item label="社会信用代码">
        <el-input v-model="form.credit_number" placeholder="请输入社会信用代码" />
      </el-form-item>
...
export default {
  data() {
    return {
      ...
      data: [
      { label: '公司名称', key: 'company_name', value: ''},
      { label: '社会信用代码', key: 'credit_number', value: ''},
  ...
  try {
      const response = await axios.post('http://10.176.22.62:8001/querynode/', params);
...
async delete(){
  ...
  const response = await axios.post('http://10.176.22.62:8000/deletenode/', requestData);
